...
/**
 * `BiasFit_USER_PERSONAS.md`의 P1~P5를 그대로 옮긴 **테스트 픽스처**다.
 * 화면 초기값으로 쓰지 않는다 — 사용자가 고르지 않은 값이 그 사람의 답으로 저장됐던
 * 문제 때문에 진단은 빈 상태에서 시작한다 (`app/appState.ts`의 `emptyDraft`).
 */
export type PersonaId = "P1" | "P2" | "P3" | "P4" | "P5";

export const personaForms: Record<PersonaId, DiagnosisForm> = {
  P1: {
    height: 158, topSize: "55 (S)", bottomSize: "55 (S)", bodyType: "웨이브",
  ...
  P2: {
    height: 163, topSize: "66 (M)", bottomSize: "66 (M)", bodyType: "내추럴",
  ...
  P3: {
    height: 166, topSize: "66 (M)", bottomSize: "66 (M)", bodyType: "스트레이트",
  ...
  P4: {
    height: 157, topSize: "55 (S)", bottomSize: "55 (S)", bodyType: "웨이브",
  ...
  P5: {
    height: 165, topSize: "66 (M)", bottomSize: "66 (M)", bodyType: "내추럴",
